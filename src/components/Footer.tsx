...
const Footer = () => {
  ...
  const socialLinks = [
    { icon: Instagram, href: 'https://www.instagram.com/sangharsh__graphic__design__16?igsh=bzM5d3J1cngwanNz', label: 'Instagram' },
    { icon: Facebook, href: 'https://www.facebook.com/share/1DBrz3kFip/', label: 'Facebook' },
    { icon: MessageCircle, href: 'https://wa.me/919545563314', label: 'WhatsApp' }
  ];
          ...
          <div className="space-y-6">
            ...
            <div className="space-y-3">
              ...
              <div className="flex items-center space-x-3">
                ...
                <span>Loha Nanded Maharashtra 431708</span>
              </div>
            </div>
          </div>
