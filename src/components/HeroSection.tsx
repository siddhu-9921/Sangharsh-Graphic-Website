  ...
  return (
    <section id="home" className="relative min-h-screen flex items-center justify-center overflow-hidden">
      ...
      <div className="absolute inset-0 z-10 pointer-events-none">
        ...
        <div className="absolute bottom-32 left-20 w-12 h-12 bg-secondary/25 rounded-full animate-float" style={{ animationDelay: '4s' }} />
      </div>
      ...
      <div className="relative z-20 text-center px-4 max-w-4xl mx-auto">
        ...
        <p className="text-lg text-white/80 mb-12 max-w-2xl mx-auto animate-fadeInUp" style={{ animationDelay: '0.6s' }}>
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center items-center animate-fadeInUp" style={{ animationDelay: '0.8s' }}>
          ...
          <Button 
            size="lg" 
            variant="outline"
            className="border-2 border-white text-white hover:bg-white hover:text-primary shadow-glow hover-lift px-8 py-4 text-lg"
          >
